...
function header_init(){
    ...
    function setDom() {
        ...
        if(_browserNew.versions.iPhone || _browserNew.versions.android){
            ...
            $('head').append('<link href="/css/ie7_new.css" rel="stylesheet" type="text/css">');

        }else if(_browserNew.versions.ie==6){
            $('head').append('<link href="/css/ie6_new.css" rel="stylesheet" type="text/css">');
        }
    ...
    function addEvt() {
        ...
        $('#hdSubSearchBtn').click(function() {
            ...
            window.location= '/results/?q='+ indexSearchKeyword
        })
